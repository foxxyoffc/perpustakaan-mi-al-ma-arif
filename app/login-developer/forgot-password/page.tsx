    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-3xl border border-emerald-900/10 bg-white p-6 shadow-[0_20px_70px_rgba(15,61,36,0.10)] sm:p-8">
          {/* Icon */}
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-950/10 text-emerald-950">
          ...
          <div className="mt-6">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-500">
              Akses developer merupakan akses utama sistem. Untuk
              alasan keamanan, pemulihan akun dilakukan melalui
              proses verifikasi.
            </p>
          </div>

          {/* Security notice */}
          <div className="mt-6 flex gap-3 rounded-2xl border border-red-100 bg-red-50/70 p-4">
            ...
            <div>
              <p className="text-xs font-semibold text-red-800">
                Area dengan akses tinggi
              </p>

              <p className="mt-1 text-xs leading-5 text-red-700">
                Jangan membagikan username, password, kode
                verifikasi, atau informasi keamanan developer kepada
                siapapun.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-2xl border border-slate-100 bg-slate-50 p-4">
            <div className="flex gap-3">
              ...
              <p className="text-xs leading-5 text-slate-600">
                Password developer tidak dapat ditampilkan kembali
                oleh sistem. Jika Anda kehilangan akses, hubungi
                kontak yang telah dikonfigurasi pada website untuk
                proses pemulihan.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 space-y-3">
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="mt-1 block text-xs leading-5 text-slate-500">
                  Kembali ke halaman pendaftaran user.
                </span>
              </span>
            ...
            {/* Contact */}
            <Link
              href="/report?type=developer-forgot-password"
              className="group flex w-full items-center gap-4 rounded-2xl border border-emerald-900/10 bg-white p-4 transition duration-300 hover:-translate-y-0.5 hover:border-emerald-900/20 hover:bg-emerald-50/50 hover:shadow-md"
            >
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-950/10 text-emerald-950">
                <MessageIcon className="h-5 w-5" />
              </span>

              <span className="min-w-0 flex-1">
                <span className="block text-sm font-semibold text-emerald-950">
                  Laporkan / Hubungi Kontak
                </span>

                <span className="mt-1 block text-xs leading-5 text-slate-500">
                  Kirim laporan mengenai kendala akses developer.
                </span>
              </span>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-emerald-800/80">
                  Setelah identitas berhasil diverifikasi, password
                  dapat diatur ulang melalui sistem administrator
                  utama.
                </p>
              </div>
            </div>
