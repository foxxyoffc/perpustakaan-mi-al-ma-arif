        ...
        <div className="rounded-3xl border border-emerald-900/10 bg-white p-6 shadow-[0_20px_70px_rgba(15,61,36,0.10)] sm:p-8">
          ...
          <div className="mt-6">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-500">
              Jangan khawatir. Silakan pilih salah satu opsi di
          ...
          <div className="mt-7 space-y-3">
            ...
            {/* Contact admin */}
            <Link
              href="/report?type=forgot-password"
              className="group flex w-full items-center gap-4 rounded-2xl border border-emerald-900/10 bg-white p-4 transition duration-300 hover:-translate-y-0.5 hover:border-emerald-900/20 hover:bg-emerald-50/50 hover:shadow-md"
            >
              <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-900/10 text-emerald-900">
              ...
              <span className="min-w-0 flex-1">
                <span className="block text-sm font-semibold text-emerald-950">
                  Laporkan / Hubungi Admin
                </span>

                <span className="mt-1 block text-xs leading-5 text-slate-500">
                  Kirim laporan agar admin dapat membantu memulihkan akun.
                </span>
              </span>
          ...
          <div className="mt-6 flex gap-3 rounded-2xl border border-slate-100 bg-slate-50 p-4">
            ...
            <p className="text-xs leading-5 text-slate-500">
              Demi keamanan akun, jangan pernah memberikan password
              kepada orang lain. Admin akan melakukan verifikasi
              sebelum membantu perubahan akses akun.
            </p>
          </div>
...
function HelpIcon({
  ...
  return (
    ...
    >
      ...
      <path d="M9.8 9a2.4 2.4 0 1 1 4.4 1.3c-.7.9-2.2 1.3-2.2 2.7" />
      <path d="M12 16.5h.01" />
    </svg>
  );
}
